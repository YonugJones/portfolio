const About = () => {
  return (
    <div className='py-10'>
      <h1 className='text-3xl text-center pb-2'>About Me</h1>
      <p>
        <span className='font-medium text-[var(--dark-three)]'>I began</span> as
        a general manager at a bakery where I worked with patrons to design
